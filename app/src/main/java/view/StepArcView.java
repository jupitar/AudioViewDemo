...
public class StepArcView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        /**【第三步】绘制当前进度的红色数字*/
        drawTextNumberTest(canvas, centerX);
//        drawTextNumber(canvas, centerX);
    ...
    private void drawTextNumber(Canvas canvas, float centerX) {
        ...
        //+ bounds_Number.height() / 2  +bounds_Number.height() / 2
        canvas.drawText(stepNumber, centerX, getHeight() / 2+bounds_Number.height() / 2+getFontHeight(numberTextSize)+30 , vTextPaint);
     ...
     * @param centerX
     */
    private void drawTextNumberTest(Canvas canvas, float centerX) {
        Paint vTextPaint = new Paint();
        vTextPaint.setTextAlign(Paint.Align.CENTER);
        vTextPaint.setAntiAlias(true);//抗锯齿功能
        vTextPaint.setTextSize(numberTextSize);
